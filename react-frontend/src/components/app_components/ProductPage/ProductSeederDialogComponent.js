...
import seederData from "./product.seeder.json";
...
const ProductSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProductSeederDialogComponent);
